...
import { FloatingDustParticles } from '../ui/FloatingDustParticles';
...
export const HeroDual: React.FC<HeroDualProps> = ({ onNavigate, onOpenBooking }) => {
  return (
    <section className="relative overflow-hidden bg-[#F7F3EA] py-8 lg:py-12 border-b border-[#E8DFD1] min-h-[calc(100vh-80px)] flex items-center justify-center">
      {/* Floating Sparkle Dust Particles Effect */}
      <FloatingDustParticles />

      {/* Background Silk Texture Overlay */}
      <div className="absolute inset-0 bg-[url('/images/sage_silk_bg.png')] bg-cover bg-center opacity-[0.18] pointer-events-none mix-blend-multiply" />
      {/* Background Radial Glow Effect */}
      <div className="hero-background-glow"></div>

      {/* Background Botanical Branch Textures */}
      <BotanicalBranch className="absolute -top-10 -right-10 w-96 h-[400px] text-[#7E8B72]" opacity={0.12} />
      <BotanicalBranch className="absolute -bottom-20 -left-20 w-80 h-[380px] text-[#AEB9A5] rotate-45" opacity={0.1} />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center">
          ...
          <div className="lg:col-span-6 space-y-4 lg:space-y-5 text-center lg:text-left">
            ...
            <h1 className="font-serif text-3xl sm:text-5xl lg:text-6xl font-bold text-[#243126] leading-[1.1] tracking-tight">
            ...
            <div className="pt-1 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3.5">
              <button
                ...
                className="w-full sm:w-auto bg-[#243126] hover:bg-[#3E4A2A] text-[#F7F3EA] px-8 py-3.5 rounded-full text-xs font-semibold uppercase tracking-[0.2em] shadow-md hover:shadow-lg transition-all flex items-center justify-center gap-2.5 group"
              >
              ...
              <button
                ...
                className="w-full sm:w-auto bg-transparent hover:bg-[#E8DFD1]/50 text-[#243126] border border-[#AEB9A5] px-8 py-3.5 rounded-full text-xs font-semibold uppercase tracking-[0.2em] transition-all flex items-center justify-center gap-2 shadow-sm"
              >
          ...
          <div className="lg:col-span-6 relative mt-4 lg:mt-0">
            <div className="relative max-w-md mx-auto lg:max-w-none">
              ...
              <div className="relative rounded-[2rem] overflow-hidden shadow-xl border-4 border-white editorial-image-container z-10 w-full sm:w-[88%] ml-auto max-h-[380px] sm:max-h-[420px]">
                <img
                  src="/images/skincare_facial_treatment.png"
                  alt="Signature Facial & Skincare Sanctuary"
                  className="w-full h-full object-cover editorial-image-zoom aspect-[16/11]"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#243126]/90 via-[#243126]/30 to-transparent p-5 sm:p-6 flex flex-col justify-end">
                  <div className="max-w-[65%]">
                    <span className="text-[10px] uppercase font-bold tracking-[0.25em] text-[#AEB9A5]">Skin Health Studio</span>
                    <h3 className="font-serif text-white text-lg sm:text-2xl font-bold leading-tight">Approachable Skincare</h3>
                  </div>
                </div>
              </div>

              {/* Smaller Overlapping Detail Image (Positioned on the Right Edge) */}
              <div className="absolute -bottom-4 -right-2 sm:-right-4 z-20 w-40 sm:w-48 aspect-[4/3] rounded-2xl overflow-hidden shadow-xl border-4 border-white editorial-image-container hidden sm:block">
                <img
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#243126]/85 via-transparent to-transparent p-3 flex flex-col justify-end">
              ...
              {/* Top Accent Badge */}
              <div className="absolute -top-4 left-8 z-20 bg-white/90 backdrop-blur-md px-4 py-2 rounded-full border border-[#E8DFD1] shadow-md hidden sm:flex items-center gap-2">
      ...
      <div 
        ...
        className="hidden lg:flex flex-col items-center gap-1 absolute bottom-1 left-1/2 -translate-x-1/2 opacity-85 hover:opacity-100 transition-opacity cursor-pointer z-30"
      >
        <span className="text-[9px] uppercase font-semibold tracking-[0.3em] text-[#7E8B72]">Scroll</span>
        <div className="w-[1px] h-7 bg-gradient-to-b from-[#7E8B72] to-transparent animate-pulse" />
      </div>
    </section>
  );
};
